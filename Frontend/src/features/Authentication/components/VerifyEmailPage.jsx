...
const VerifyEmailPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg relative overflow-hidden w-full p-6">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30%] max-w-[800px] h-[30%] bg-primary/20 blur-[120px] rounded-full pointer-events-none "></div>
      ...
      <div className="w-full max-w-[500px] relative z-10 animate-fade-in-up">
        <div className="relative bg-bg border border-border/40 rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.2),0_0_20px_rgba(255,87,9,0.1)] p-8 sm:p-12 backdrop-blur-2xl overflow-hidden group text-center">
          {/* Top Primary Accent */}
