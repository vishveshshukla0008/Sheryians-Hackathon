...
const FirstIncident = () => {
  return (
    <div className="space-y-20 animate-fade-in-up">
      {/* 🔥 HEADER */}
      <section>
        <h1 className="text-4xl font-bold mb-4">Create Your First Incident</h1>

        <p className="text-text-muted max-w-2xl">
          Let’s walk through how an incident is created inside MayDayOps. This
          simulation shows how teams log, track, and resolve issues in
          real-time.
        </p>
      </section>
  ...
  hover:scale-105 transition shadow-[0_0_20px_rgba(255,37,37,0.4)]">
        ...
        {/* RIGHT → LIVE PREVIEW */}
        <div className="p-6 border border-border rounded-2xl bg-bg-surface font-mono text-ms space-y-2">
      ...
      <section className="flex flex-wrap gap-4 justify-center">
        {["Detected", "Assigned", "Investigating", "Resolved"].map(
          (step, i) => (
            <div
              key={i}
      ...
      {/* 🔥 API BLOCK */}
      <section>
        <h2 className="text-2xl font-bold mb-4">API Equivalent</h2>
...

{
  ...
  "service": "payments-api"
      ...
      <section className="p-6 rounded-xl border border-primary/30 bg-primary/5">
        <h3 className="text-primary font-semibold mb-2">⚡ Why this matters</h3>

        <p className="text-text-muted text-sm">
          A well-structured incident ensures faster response, better
          collaboration, and improved system reliability. MayDayOps helps teams
          stay aligned and reduce downtime significantly.
        </p>
      </section>
    </div>
  );
