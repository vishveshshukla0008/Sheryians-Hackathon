...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post("/contact", apiBody);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-12 animate-fade-in-up">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-bg-surface border border-border text-text-muted font-semibold text-xl shadow-sm">
              ...
              <p className="text-lg text-text-muted leading-relaxed max-w-md">
                Have questions or ready to transform your business operations
                with MayDayOps? Our enterprise team is here to help.
              </p>
            </div>
              ...
              {[
                {
                  icon: FiMail,
                  title: "Email us",
                  value: "smaydayops3@gmail.com",
                  link: "mailto:smaydayops3@gmail.com",
                },
                {
                  icon: FiPhone,
                  title: "Call us",
          ...
          <div className="lg:col-span-7 lg:sticky lg:top-24 [animation-delay:200ms] animate-float relative">
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center justify-center py-16 text-center animate-fade-in-up">
                  ...
                  <p className="text-text-muted text-lg max-w-md mx-auto">
                    Thanks — we've received your inquiry. Our team will reach
                    out about using MayDayOps for your company shortly.
                  </p>
                  <Button
                    variant="outline"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 w-full">
                      <label
                        htmlFor="intent"
                        className="text-md font-bold text-text ml-1 opacity-80">
                        How can we help?
                      </label>
            ...
            <div className="absolute -inset-1 bg-linear-to-b from-primary/20 to-transparent rounded-[2.5rem] -z-10 blur-xl opacity-50"></div>
          </div>
        </div>
      </div>
    </main>
