  ...
  return (
    <>
      ...
      <div
        ...
        <aside
          className="relative lg:fixed left-0 top-0 h-full lg:h-screen w-full lg:w-64 border-b border-border lg:border-b-0 lg:border-r p-5 bg-bg z-50 overflow-y-auto"
          style={{
            scrollbarWidth: "none", // Firefox
            msOverflowStyle: "none", // IE/Edge
          }}>
          ...
          <div className="space-y-6 text-sm">
            ...
            <div>
              ...
              <div className="space-y-1">
                <NavLink
                  to="/docs/workspaces"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-bg-surface hover:text-primary transition">
        ...
        {/* 🔥 CONTENT AREA */}
        <main
          className="ml-0 lg:ml-64 p-4 sm:p-6 lg:p-8 min-h-screen overflow-y-auto"
          style={{
            scrollbarWidth: "none", // Firefox
            msOverflowStyle: "none", // IE/Edge
          }}>
